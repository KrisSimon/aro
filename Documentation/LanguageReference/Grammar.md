...
This document provides the complete formal grammar specification for ARO using Extended Backus-Naur Form (EBNF).
...
(* Comparisons *)
comparison = variable , comparison_op , ( variable | literal ) ;
